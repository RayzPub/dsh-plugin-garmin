...
class GarminWatchFaceView extends WatchUi.WatchFace {
    ...
    function onUpdate(dc as Graphics.Dc) as Void {
        ...
        dc.drawText(130, 75, Graphics.FONT_NUMBER_MILD, timeStr, Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER);
        ...
        dc.setColor(Graphics.COLOR_DK_GRAY, Graphics.COLOR_TRANSPARENT);
        dc.setPenWidth(4);
        drawArcRing(dc, 75, 150, 22, 135, 270);
        dc.setColor(Graphics.COLOR_RED, Graphics.COLOR_TRANSPARENT);
        dc.setPenWidth(4);
        drawArcRing(dc, 75, 150, 22, 135, hrPct_0 * 270.0);
        dc.setColor(Graphics.COLOR_RED, Graphics.COLOR_TRANSPARENT);
        dc.drawText(75, 154, Graphics.FONT_XTINY, hrStr_0, Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER);
        dc.setColor(Graphics.COLOR_LT_GRAY, Graphics.COLOR_TRANSPARENT);
        dc.drawText(75, 140, Graphics.FONT_XTINY, "HR", Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER);
        ...
        dc.setColor(Graphics.COLOR_DK_GRAY, Graphics.COLOR_TRANSPARENT);
        dc.setPenWidth(4);
        drawArcRing(dc, 185, 150, 22, 135, 270);
        dc.setColor(0x00FFAA, Graphics.COLOR_TRANSPARENT);
        dc.setPenWidth(4);
        drawArcRing(dc, 185, 150, 22, 135, stepPct_1 * 270.0);
        dc.setColor(0x00FFAA, Graphics.COLOR_TRANSPARENT);
        dc.drawText(185, 154, Graphics.FONT_XTINY, stepCount_1.toString(), Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER);
        dc.setColor(Graphics.COLOR_LT_GRAY, Graphics.COLOR_TRANSPARENT);
        dc.drawText(185, 140, Graphics.FONT_XTINY, "STEP", Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER);

        // Complication: Battery (progress bar) (#3)
        var bat_2 = (sysStats != null && sysStats.battery != null) ? sysStats.battery.toNumber() : 0;
        var batCol_2 = (bat_2 <= 20) ? Graphics.COLOR_RED : Graphics.COLOR_BLUE;
        dc.setColor(Graphics.COLOR_DK_GRAY, Graphics.COLOR_TRANSPARENT);
        dc.fillRectangle(112, 200, 36, 6);
        dc.setColor(batCol_2, Graphics.COLOR_TRANSPARENT);
        var batW_2 = 36 * bat_2 / 100;
        if (batW_2 > 0) {
            dc.fillRectangle(112, 200, batW_2, 6);
        }
        dc.setColor(batCol_2, Graphics.COLOR_TRANSPARENT);
        dc.drawText(130, 194, Graphics.FONT_XTINY, bat_2.toString() + "%", Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER);
        ...
        dc.setColor(Graphics.COLOR_DK_GRAY, Graphics.COLOR_TRANSPARENT);
        dc.fillRectangle(104, 112, 52, 16);
        dc.setColor(Graphics.COLOR_YELLOW, Graphics.COLOR_TRANSPARENT);
        dc.setPenWidth(1);
        dc.drawLine(104, 112, 156, 112);
        dc.drawLine(156, 112, 156, 128);
        dc.drawLine(156, 128, 104, 128);
        dc.drawLine(104, 128, 104, 112);
        dc.drawText(130, 120, Graphics.FONT_XTINY, dateStr_3, Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER);
        // --- Analog Hands ---
        ...
        // Hour Hand
        var hx = cx + 45 * Math.sin(hAngle);
        var hy = cy - 45 * Math.cos(hAngle);
        dc.setColor(Graphics.COLOR_ORANGE, Graphics.COLOR_TRANSPARENT);
        dc.setPenWidth(3);
        dc.drawLine(cx, cy, hx, hy);

        // Minute Hand
        var mx = cx + 70 * Math.sin(mAngle);
        var my = cy - 70 * Math.cos(mAngle);
        dc.setColor(Graphics.COLOR_WHITE, Graphics.COLOR_TRANSPARENT);
        dc.setPenWidth(2);
        ...
        if (!_isSleep) {
            ...
            var sx = cx + 85 * Math.sin(sAngle);
            var sy = cy - 85 * Math.cos(sAngle);
